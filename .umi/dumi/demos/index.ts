...
export default {
  'country-code-input-basic': {
    ...
    previewerProps: {"sources":{"_":{"jsx":rawCode1}},"dependencies":{"@ehome/unite-components":{"version":"0.0.1-beta.2"},"react":{"version":"^16.13.1"},"antd":{"version":"^4.21.5","css":"antd/dist/antd.css"},"react-dom":{"version":"^16.13.1"}},"identifier":"country-code-input-basic"},
  },
  'country-code-input-withform': {
    ...
    previewerProps: {"sources":{"_":{"jsx":rawCode2}},"dependencies":{},"identifier":"country-code-input-withform"},
  },
};
